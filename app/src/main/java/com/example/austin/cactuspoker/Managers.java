...
public class Managers extends AppCompatActivity {
    ...
    private ListView manager_cards;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.managers_main);
...
//                    mTextMessage.setText(R.string.action_upgrades);
    ...
    protected void setUpManagerMain() {
        manager_cards = (ListView) findViewById(R.id.manager_card_listview);
        ManagerAdapter adapter = new ManagerAdapter(this);
        adapter.addAll(ManagerCard.manager_collection);
        manager_cards.setAdapter(adapter);
    }
